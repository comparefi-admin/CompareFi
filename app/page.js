...
>>>>>>> 9069c4c12e61d725b7c972ceff4e4189a5721d8b
      ...
      >
        ...
        <main className="flex-grow bg-gradient-to-b from-violet-100/70 to-white">
          ...
          <section className="relative flex items-center justify-center min-h-[85vh] bg-white bg-opacity-0 overflow-hidden px-4 sm:px-6 lg:px-10">
            ...
            >
              <SpotlightCard
                className="relative z-10 w-[90%] max-w-full rounded-3xl   min-h-[70vh] bg-gradient-to-b from-[#6D8EF4] to-[#3D66E1]
...
>>>>>>> 9069c4c12e61d725b7c972ceff4e4189a5721d8b
                  ...
                  >
                    <Button
                      ...
                      onClick={() =>
                        document
                          .getElementById("compare-products")
                          ?.scrollIntoView({
                            behavior: "smooth",
                          })
                      }
                ...
                <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-b from-[#6D8EF4] to-[#3D66E1] shadow-md">
                  ...
                  >
                    <path
                      ...
                      strokeWidth="2"
                      d="M12 8v4l3 3m6 2a9 9 0 11-9-9 9 9 0 019 9z"
                    />
                  </svg>
                </div>
          ...
          <section
            id="compare-products"
            className="relative flex justify-center items-center mt-[8%] overflow-hidden px-4 sm:px-6 lg:px-10 bg-white bg-opacity-0"
          >
            {/* Background noise layer */}
            ...
            <SpotlightCard
              className="relative z-10 border-none h-full  w-[95%] rounded-3xl bg-gradient-to-b from-[#6D8EF4] to-[#3D66E1] backdrop-blur-lg  shadow-xl p-8 sm:p-12 md:p-16 flex flex-col"
                          ...
                          <div>
                            ...
                            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                              <Link href={`/products/${p.id}`}>
                                <Button size="lg">Deep Dive</Button>
                              </Link>
                            </div>
                          </div>
