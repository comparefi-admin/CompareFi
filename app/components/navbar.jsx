...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-4 left-0 w-full z-50 flex justify-center px-4 pt-2">
      ...
      <nav
        className={`flex h-16 pointer-events-auto rounded-full border px-6 py-3 transition-all duration-300 items-center
          ${isScrolled
                ...
                <Link
                  ...
                  className={`px-4 py-2 rounded-full flex items-center space-x-2 transition
                    ${isActive
                      ...
                      : "text-gray-820 hover:bg-gray-100 hover:text-black"
                    }
                  `}
                >
                  <Icon
