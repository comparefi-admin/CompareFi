...
import { 
  Mail, Phone, MapPin, User, Smartphone, 
  CreditCard, FileText, Loader2, CheckCircle, 
  XCircle, Clock, ArrowRight, MessageSquare 
} from "lucide-react";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      */
      ...
      setStatus({ type: "success", message: "Request received! We'll call you shortly." });
      setFormData({ name: "", mobile: "", email: "", product: "", pan: "", message: "" });
    } catch (err) {
      ...
      <main className="relative z-10 flex-grow pt-[140px] pb-20 px-4 sm:px-6">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
            ...
            <div className="lg:col-span-5 flex flex-col gap-8">
                ...
                >
                    ...
                    <div className="space-y-8 relative z-10">
                        <TimelineItem number="01" title="We receive your request" desc="Our system instantly routes your enquiry to the relevant financial expert." />
                        <TimelineItem number="02" title="Analysis & Preparation" desc="We analyze your requirements to find the best lenders for your portfolio." />
                        <TimelineItem number="03" title="Personalized Call" desc="Within 24 hours, an expert calls you with tailored offers." isLast />
                    </div>
                </motion.div>
            </div>
            ...
            <div className="lg:col-span-7 h-full">
                ...
                >
                    <div className="mb-8">
                        <h2 className="text-3xl font-bold text-[#0A0F2C]">Send us a message</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid sm:grid-cols-2 gap-6">
                            ...
                            <InputGroup icon={Smartphone} name="mobile" placeholder="Mobile Number" value={formData.mobile} onChange={handleChange} />
                        </div>
                        ...
                        <InputGroup icon={FileText} name="pan" placeholder="PAN Number (Optional)" value={formData.pan} onChange={handleChange} />
        ...
        <section className="max-w-7xl mx-auto mt-20 relative">
             ...
             >
                ...
                <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.792576596956!2d72.87513077596045!3d19.07284435207797!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c89010072d7d%3A0x67623a9b1c7c00e1!2sBandra%20Kurla%20Complex!5e0!3m2!1sen!2sin!4v1709220000000!5m2!1sen!2sin"
                ...
                <div className="absolute bottom-6 left-6 right-6 md:left-12 md:bottom-12 md:right-auto md:w-[400px]">
                    <SpotlightCard className="bg-white/90 backdrop-blur-md border border-white/40 p-6 rounded-2xl shadow-xl">
                        <div className="flex items-start justify-between mb-4">
                            <div>
                                <h4 className="text-lg font-bold text-[#0A0F2C]">Mumbai HQ</h4>
                                <p className="text-sm text-gray-500">Financial District</p>
                            </div>
                        ...
                        <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                            1203, Capital Towers, Bandra Kurla Complex,<br /> Mumbai, Maharashtra 400051
                        </p>
...
const TimelineItem = ({ number, title, desc, isLast }) => (
    <div className="relative pl-4 border-l-2 border-green-400/30">
        ...
        <span className="text-green-300 text-xs font-bold tracking-widest uppercase mb-1 block">Step {number}</span>
...
const ContactItem = ({ icon: Icon, label, value, href }) => (
    <div className="flex items-center gap-4 group">
        ...
        <div>
            ...
            {href ? (
                <a href={href} className="text-lg font-semibold text-[#0A0F2C] hover:text-[#10B981] transition-colors">
                    {value}
                </a>
            ) : (
