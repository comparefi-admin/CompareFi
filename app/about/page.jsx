    ...
    >
      ...
      <main className="relative z-10 pt-[160px] pb-20 px-4 sm:px-6">
        ...
        <section className="max-w-7xl mx-auto mb-20 lg:mb-32 text-center flex flex-col items-center">
          ...
          >
            A mission driven platform built to bring transparency to India’s
            financial ecosystem. No hidden agendas, just pure data.
          </motion.p>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-[#0A0F2C] mb-6">
                  ...
                  <span className="text-green-600">institutions</span> and{" "}
                  <span className="text-green-600">individuals</span>.
                </h2>

                <p className="text-gray-600 text-lg leading-relaxed mb-8">
                  I’m Het Doshi, a Chartered Accountant by qualification and an
                  auditor by experience. Over years, I’ve worked across some of
                  the most regulated sectors in India, including NBFCs, stock
                  brokers, wealth managers, and mutual funds. My career in
                  consulting has given me a front row seat to the inner workings
                  of the financial services industry both its strengths and its
                  hidden complexities. <br></br>
                  <br></br>
                ...
                <div className="flex items-center gap-4 pt-6 border-t border-gray-200">
                  <div className="flex flex-col">
                    <span className="text-2xl font-serif italic text-[#1F5E3C]">
                      Het Doshi
                    </span>
        ...
        <section className="max-w-7xl mx-auto mb-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#0A0F2C]">
              Why We Exist
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white/50 backdrop-blur-xl border border-white/40 rounded-3xl p-8 sm:p-10 shadow-lg flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  We are bootstrapped. No investors to please. No banks paying
                  us to rank them higher. Just raw, honest data.
                </p>
              </div>
              <div className="mt-8">
                <div className="text-4xl font-extrabold text-[#1F5E3C]">
                  100%
                </div>
            ...
            <div className="bg-white/50 backdrop-blur-xl border border-white/40 rounded-3xl p-8 sm:p-10 shadow-lg flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  If CompareFi helps even one person avoid a bad financial
                  decision, our mission is successful.
                </p>
              </div>
            </div>
            ...
            <SpotlightCard className="md:col-span-2 bg-white rounded-3xl p-8 sm:p-10 shadow-lg border border-gray-100 flex flex-col justify-center relative">
              ...
              <p className="text-2xl sm:text-3xl font-bold text-[#0A0F2C] leading-snug max-w-2xl relative z-10">
                "To build a financially confident India, driven by clarity,
                simplicity, and absolute transparency."
              </p>
            </SpotlightCard>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto pb-20">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-[#0A0F2C] mb-3">
                Our Mission Pillars
              </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {missions.map((item, idx) => (
              ...
              >
                ...
                <h4 className="font-bold text-[#0A0F2C] mb-2 text-2xl">
                  {item.title}
                </h4>
