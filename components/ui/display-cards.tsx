...
/* -----------------------------------------------
   Single Card Component — Responsive SAFE
------------------------------------------------ */
function DisplayCard({
  ...
  return (
    <div
      className={cn(
        // Responsive size ONLY — proportions unchanged
    ...
    >
      ...
      <div className="flex flex-col gap-4 w-full relative z-10">
        {data.map((item, idx) => (
          <div
            key={idx}
            className="flex flex-col rounded-xl bg-white/95 py-4 px-4 shadow-sm border border-[#e1e5f0]"
          >
...
export default function DisplayCards() {
  ...
  // Breakpoint-safe transforms
  const cardLayoutClasses = [
    "lg:z-10 lg:rotate-[-12deg] lg:translate-x-[30px] lg:translate-y-[24px]",
    "lg:z-30 lg:rotate-0 lg:translate-y-[-24px]",
    "lg:z-20 lg:rotate-[12deg] lg:translate-x-[-30px] lg:translate-y-[24px]",
  ];

  return (
    <div className="flex justify-center items-center py-20 mt-2 origin-top">
      <div
        className={cn(
          // Desktop: overlapped
          "hidden lg:flex justify-center items-center -space-x-20 scale-[1.20]",
          ...
          return (
            <div
              ...
              className={cn(
                ...
                cardLayoutClasses[i],
                isHovered &&
  "lg:z-50 lg:rotate-0 lg:translate-x-0 lg:translate-y-[-80px] lg:scale-[1.18] will-change-transform transform-gpu"
      ...
      {/* Mobile / Tablet stack */}
      <div className="flex flex-col gap-10 lg:hidden scale-[0.95] sm:scale-[1]">
        {cards.map((card, i) => (
          <DisplayCard key={i} {...card} isMasked={false} />
        ))}
      </div>
    </div>
  );
